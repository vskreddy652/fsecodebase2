...
public class UsersBean {
	...
	public UsersBean(final String userFirstName, final String userLastName, final String userName,
			final String userPassword, final String userEmail, final String userRole, final String userMobile,
			final String userAddress, final String userCity, final String userCityPincode,
			final Boolean userAgreementAccepted, final String userRequestMessage, final Boolean userApproved) {
		this.userFirstName = userFirstName;
		this.userLastName = userLastName;
		this.userName = userName;
		this.userPassword = userPassword;
